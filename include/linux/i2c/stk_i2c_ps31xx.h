...
struct stk31xx_pls_platform_data {
	int irq_gpio_number;
};
...
#if( !defined(CONFIG_STK_PS_ALS_USE_CHANGE_THRESHOLD) && defined(CONFIG_STK_PS_INT_MODE))
...
#endif 	//#if( !defined(CONFIG_STK_PS_ALS_USE_CHANGE_THRESHOLD) && defined(CONFIG_STK_PS_INT_MODE))
