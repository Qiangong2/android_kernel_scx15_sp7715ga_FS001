...
static int npi_cmd_is_unsupport(const char *cmd_name)
{
    ...
    {
        if (NULL != rf_unsupport_cmd[i] && 0 == strcmp(cmd_name, rf_unsupport_cmd[i]))
        {
...
{							\
    ...
    { \
        /* if cmd is unsupported in RF, return 0, because APK handle unsupport cmd's return value must be 0 */ \
        pr_err("ADL %s(), npi_cmd_is_unsupport() return true\n", __func__); \
        ret = 0; \ 
    } \
    else \
    { \
        /* if cmd is support in RF, send it to RF Layer */ \
...
NPI_SET_CMD(set_channel, NPI_CMD_CHANNEL, NLNPI_CMD_SET_CHANNEL, NLNPI_ATTR_SET_CHANNEL)
NPI_SET_CMD(set_tx_power, NPI_CMD_TX_POWER, NLNPI_CMD_SET_TX_POWER, NLNPI_ATTR_SET_TX_POWER)
NPI_SET_CMD(set_rx_count, NPI_CMD_RX_COUNT, NLNPI_CMD_CLEAR_RX_COUNT, NLNPI_ATTR_SET_RX_COUNT)
NPI_SET_CMD(set_tx_mode, NPI_CMD_TX_MODE, NLNPI_CMD_SET_TX_MODE, NLNPI_ATTR_SET_TX_MODE)
NPI_SET_CMD(set_tx_count, NPI_CMD_TX_COUNT, NLNPI_CMD_SET_TX_COUNT, NLNPI_ATTR_TX_COUNT)

/* set_pkt_length */
NPI_SET_CMD(set_pkt_length, NPI_CMD_PKTLEN, NLNPI_CMD_SET_PKTLEN, NLNPI_ATTR_SET_PKTLEN)

/* set_preamble */
NPI_SET_CMD(set_preamble, NPI_CMD_PREAMBLE_TYPE, NLNPI_CMD_SET_PREAMBLE_TYPE, NLNPI_ATTR_SET_PREAMBLE_TYPE)

/* set_band */
NPI_SET_CMD(set_band, NPI_CMD_BAND, NLNPI_CMD_SET_BAND, NLNPI_ATTR_SET_BAND)

/* set_bandwidth */
NPI_SET_CMD(set_bandwidth, NPI_CMD_BANDWIDTH, NLNPI_CMD_SET_BANDWIDTH, NLNPI_ATTR_SET_BANDWIDTH)

/* set_guard_interval */
NPI_SET_CMD(set_guard_interval, NPI_CMD_SHORTGI, NLNPI_CMD_SET_SHORTGI, NLNPI_ATTR_SET_SHORTGI)

/* set_macfilter */
NPI_SET_CMD(set_macfilter, NPI_CMD_MACFILTER, NLNPI_CMD_SET_MACFILTER, NLNPI_ATTR_SET_MACFILTER)

/* set_payload */
NPI_SET_CMD(set_payload, NPI_CMD_PAYLOAD, NLNPI_CMD_SET_PAYLOAD, NLNPI_ATTR_SET_PAYLOAD)
...
NPI_GET_CMD(get_macfilter, NPI_CMD_MACFILTER, NLNPI_CMD_GET_MACFILTER, NLNPI_ATTR_GET_MACFILTER, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_band, NPI_CMD_BAND, NLNPI_CMD_GET_BAND, NLNPI_ATTR_GET_BAND, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_bandwidth, NPI_CMD_BANDWIDTH, NLNPI_CMD_GET_BANDWIDTH, NLNPI_ATTR_GET_BANDWIDTH, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_guard_interval, NPI_CMD_SHORTGI, NLNPI_CMD_GET_SHORTGI, NLNPI_ATTR_GET_SHORTGI, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_payload, NPI_CMD_PAYLOAD, NLNPI_CMD_GET_PAYLOAD, NLNPI_ATTR_GET_PAYLOAD, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_tx_mode, NPI_CMD_TX_MODE, NLNPI_CMD_GET_TX_MODE, NLNPI_ATTR_GET_TX_MODE, NLNPI_ATTR_GET_NO_ARG)

NPI_GET_CMD(get_channel, NPI_CMD_CHANNEL, NLNPI_CMD_GET_CHANNEL, NLNPI_ATTR_GET_CHANNEL, NLNPI_ATTR_GET_NO_ARG)
NPI_GET_CMD(get_pkt_length, NPI_CMD_PKTLEN, NLNPI_CMD_GET_PKTLEN, NLNPI_ATTR_GET_PKTLEN, NLNPI_ATTR_GET_NO_ARG)

NPI_GET_CMD(get_preamble, NPI_CMD_PREAMBLE_TYPE, NLNPI_CMD_GET_PREAMBLE_TYPE, NLNPI_ATTR_GET_PREAMBLE_TYPE, NLNPI_ATTR_GET_NO_ARG)

NPI_GET_CMD(get_tx_power, NPI_CMD_TX_POWER, NLNPI_CMD_GET_TX_POWER, NLNPI_ATTR_GET_TX_POWER, NLNPI_ATTR_GET_NO_ARG)
