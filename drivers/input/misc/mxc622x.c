...
static ssize_t mxc622x_xyz_data_show(struct device *dev,
				   struct device_attribute *attr, char *buf)
{
	struct mxc622x_acc_data	*acc = mxc622x_acc_misc_data;
...
static DEVICE_ATTR(delay, S_IRWXU | S_IRWXG | S_IROTH,
...
static DEVICE_ATTR(position, S_IRWXU | S_IRWXG | S_IROTH,
			mxc622x_position_show, mxc622x_position_store);
static DEVICE_ATTR(chip_id, S_IRWXU | S_IRWXG | S_IROTH,
			mxc622x_chip_id_show, NULL);
static DEVICE_ATTR(xyz_data, S_IRWXU | S_IRWXG | S_IROTH,
			mxc622x_xyz_data_show, NULL);
