...
//        || !strncmp(IC_TYPE, "GT813", 5))
    if (strncmp(IC_TYPE, "GT8110", 6) && strncmp(IC_TYPE, "GT8105", 6)
        ...
        && strncmp(IC_TYPE, "GTxxx", 5) && strncmp(IC_TYPE, "GT868", 5))
    {
...
static const struct file_operations goodix_ops = {
	.owner		= THIS_MODULE,
...
s32 init_wr_node(struct i2c_client *client)
{
    ...
    register_i2c_func();
        ...
        goodix_proc_entry =  proc_create(procname, 0666, NULL,&goodix_ops); /*create_proc_entry(procname, 0666, NULL);*/
