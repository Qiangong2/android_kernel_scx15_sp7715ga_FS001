...
#if defined(CONFIG_ZYT_FLASH_CTL_BY_GPIO)
// Flash-light controlled by FLASH_LED and FLASH_EN,not by SC2713
#define CONFIG_ZYT_FLASH_CTRL_BY_GPIO
#endif
...
#if defined (CONFIG_ARCH_SCX35) && !defined (CONFIG_ZYT_FLASH_CTRL_BY_GPIO)
...
LOCAL int sprd_v4l2_setflash(uint32_t flash_mode)
{
	...
	case FLASH_TORCH:                 /*for torch */
		...
		#ifndef CONFIG_MACH_SP7715GA_5701
...
static int __init sprd_v4l2_probe(struct platform_device *pdev)
{
	...
	wake_lock_init(&dcam_wakelock, WAKE_LOCK_SUSPEND,"pm_message_wakelock_dcam");
