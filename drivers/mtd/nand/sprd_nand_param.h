...
/*JFC's JSFCBD3Y7ABBG , arvak's AMS4G2G45LA and Acsip's NCSPN4N2A have the same id */
struct sprd_nand_device arvak_device_table[] = {
	{0xBC, "AMS4G2G45LA", "4Gb, x16, 1.8V"},
	{0x00, NULL, NULL}
};

/*MXIC MX63U4GB2GBAXMI00*/
struct sprd_nand_device mxic_device_table[] = {
	{0xBC, "MX63U4GB2GBAXMI00", "4Gb, x16, 1.8V"},
	{0x00, NULL, NULL}
};
...
/*JFC's JSFCBD3Y7ABBG ,  arvak's AMS4G2G45LA and Acsip's NCSPN4N2A have the same id */
        {0x1,  "Arvak/Acsip", arvak_device_table},
	{0xC2,  "MXIC", mxic_device_table},
	{0x00, NULL, NULL}
};
...
struct sprd_nand_param sprd_nand_param_table[] = {
    ...
    //hynix compatible with spare-oob 128-32 and 64-16
   ...
   /*JFC's JSFCBD3Y7ABBG ,  arvak's AMS4G2G45LA and Acsip's NCSPN4N2A have the same id */
    ...
    /*MXIC MX63U4GB2GBAXMI00*/
	{ 	{ 0xC2, 0xBC, 0x90, 0x55, 0x57 }, 0xC2, 0xBC,
		SZ_K_BLOCK(128), NUM_BLOCK(4096), SZ_K_PAGE(2), SZ_B_SECTOR(512), SZ_B_SPARE(112), BW_16, CYCLES_5,
		{ 10, 25 ,15 }, //ace, rwl, rwh
		{ SZ_B_OOB(28), ECC_BITS(8), POS_ECC(14), SZ_ECC(14), POS_INFO(14), SZ_INFO(0) }
	},
