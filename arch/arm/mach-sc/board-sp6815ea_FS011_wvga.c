...
#endif
#if defined(CONFIG_TOUCHSCREEN_FT6X36)
...
#elif defined(CONFIG_TOUCHSCREEN_FT6X36)
static struct ft6x06_platform_data ft6x06_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vddsim2",
};
...
#elif defined(CONFIG_TOUCHSCREEN_FT6X36)
	{
		I2C_BOARD_INFO(FT6X06_NAME, FT6X06_ADDR),
