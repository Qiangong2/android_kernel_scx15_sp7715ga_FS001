...
#if defined(CONFIG_TOUCHSCREEN_FT5206)
#include <linux/i2c/ft5206_ts.h>
#endif
#if defined(CONFIG_TOUCHSCREEN_MSG2133)
...
#endif
#if defined(CONFIG_INPUT_MMA845X_I2C)||defined(CONFIG_INPUT_MMA845X_I2C_MODULE)
#include <linux/i2c/mma845x.h>
#endif
#ifdef CONFIG_INPUT_MXC622X_I2C
#include <linux/i2c/mxc622x.h>
#endif
#ifdef CONFIG_INPUT_MC3XXX_I2C
#include <linux/i2c/mc3xxx.h>
#endif
#if defined(CONFIG_INPUT_KIONIX_I2C)||defined(CONFIG_INPUT_KIONIX_I2C_MODULE)
...
#include <mach/i2s.h>
#if defined(CONFIG_KEYBOARD_GPIO)
#define GPIO_HOME_KEY 172 /* PIN LCD_D[5] */
#endif
...
static const unsigned int board_keymap[] = {
	...
	KEY(1, 0, KEY_VOLUMEDOWN),//KEY_VOLUMEUP
	//KEY(0, 1, KEY_CAMERA),
};
...
#if defined(CONFIG_TOUCHSCREEN_IT7260)
static struct it7260_ts_platform_data it7260_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vdd28",
};
#endif
#if defined(CONFIG_TOUCHSCREEN_MSG2133)
static struct msg2133_ts_platform_data msg2133_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vddsim2",
};
#endif
#ifdef CONFIG_TOUCHSCREEN_GSLX680
static struct gslX680_ts_platform_data gslX680_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name 			= "vddsim2",
};
#endif
#if defined(CONFIG_TOUCHSCREEN_GT9XX)
static struct gt9xx_ts_platform_data gt9xx_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vddsim2",
};
...
#ifdef CONFIG_INPUT_STK31XX_I2C
static struct stk31xx_pls_platform_data stk31xx_pls_info = {
	.irq_gpio_number	= GPIO_PROX_INT,
};
#endif
...
static struct stk3x1x_platform_data stk3x1x_pfdata={ 
  ...
  .ps_thd_h =1700, 
  .ps_thd_l = 1500, 
  .int_pin = GPIO_PROX_INT,  
  .transmittance = 500, 
}; 
#endif

#if defined(CONFIG_INPUT_EPL2080_I2C)
static struct elan_epl_platform_data epl2128_ts_info = {
	.intr_gpio	= GPIO_PROX_INT,
};
#endif
...
static struct mma845x_acc_platform_data mma845x_plat_data = {
	.poll_interval = 100,
	.min_interval = 1,
	.max_interval = 500,
	.g_range = MODE_2G,
...
#ifdef CONFIG_INPUT_MC3XXX_I2C
static struct mc3xxx_acc_platform_data mc3xxx_plat_data = {
	.g_position		= 3,
};
#endif
#if defined(CONFIG_INPUT_KIONIX_I2C)||defined(CONFIG_INPUT_KIONIX_I2C_MODULE)
//Alex.shi:accel_direction provide the sensor position setting , value is between 1~8
//	The relation of kionix_plat_data.accel_direction and mma845x_plat_data.g_position is:
//	mma8452		kionix
//	0			4
//	1-3,5-7		the same
//	4			8
static  const struct kionix_accel_platform_data kionix_plat_data ={
	.min_interval		= 5,
	.poll_interval		= 200,
	.accel_direction	= 4,
...
#if defined(CONFIG_TOUCHSCREEN_FT5206)
	{
		I2C_BOARD_INFO(FT5X0X_NAME, FT5206_TS_ADDR),
...
#if defined(CONFIG_TOUCHSCREEN_IT7260)
	{
		I2C_BOARD_INFO(IT7260_TS_NAME, IT7260_TS_ADDR),
		.platform_data = &it7260_ts_info,
	},
#endif
#if defined(CONFIG_TOUCHSCREEN_MSG2133)
	{
...
#ifdef CONFIG_TOUCHSCREEN_GSLX680
	{
		I2C_BOARD_INFO(GSLX680_TS_NAME, GSLX680_TS_ADDR),
		.platform_data = &gslX680_ts_info,
	},
#endif
#if defined(CONFIG_TOUCHSCREEN_GT9XX)
	{
		I2C_BOARD_INFO(GTP_I2C_NAME, GTP_TS_ADDR),
...
#endif
#if defined(CONFIG_INPUT_MMA845X_I2C)||defined(CONFIG_INPUT_MMA845X_I2C_MODULE)
	{ I2C_BOARD_INFO(MMA845X_ACC_DEV_NAME, MMA845X_I2C_ADDR),
	  .platform_data = &mma845x_plat_data,
	},
#endif
#if defined(CONFIG_INPUT_KIONIX_I2C)||defined(CONFIG_INPUT_KIONIX_I2C_MODULE)
	{ I2C_BOARD_INFO(KIONIX_ACCEL_IIC_NAME, KIONIX_ACCEL_I2C_ADDR),
	  .platform_data = &kionix_plat_data,
	},
#endif
#if(defined(CONFIG_INV_MPU_IIO)||defined(CONFIG_INV_MPU_IIO_MODULE))
...
#endif
#ifdef CONFIG_INPUT_STK31XX_I2C
	{ I2C_BOARD_INFO(STKPS_DRV_NAME,  STKALS_ADDRESS),
	  .platform_data = &stk31xx_pls_info,
	},
#endif
#ifdef CONFIG_INPUT_STK3X1X_I2C
	{ I2C_BOARD_INFO(STK3310_DEVICE_NAME,  STK3310_ADDRESS_INFO),
	  .platform_data = &stk3x1x_pfdata,
	},
#endif
#ifdef CONFIG_INPUT_EPL2080_I2C
	{ I2C_BOARD_INFO(EPL2080_ACC_I2C_NAME,  EPL2080_ACC_I2C_ADDR),
	  .platform_data = &epl2128_ts_info,
	},
#endif
#if(defined(CONFIG_SENSORS_AK8975)||defined(CONFIG_SENSORS_AK8975_MODULE))
