...
#ifndef __GPIO_SC7715EA_H__
#define __GPIO_SC7715EA_H__
...
#define GPIO_MAIN_SENSOR_PWN     164//used 163
#define GPIO_SUB_SENSOR_PWN      163//used 164
#ifdef CONFIG_ZYT_FLASH_CTL_BY_GPIO
#define GPIO_SPRD_FLASH_LOW     183     //FLASH_EN
#define GPIO_SPRD_FLASH_HIGH    181     //FLASH_LED
#define SPRD_FLASH_ON				1
#define SPRD_FLASH_OFF				0
#endif
#define SPRD_FLASH_OFST          0x8d0
#define SPRD_FLASH_CTRL_BIT      0x8000
#if defined(CONFIG_ZYT_SUPPORT)
#define SPRD_FLASH_LOW_VAL       0x1
#define SPRD_FLASH_HIGH_VAL      0x1
#else
