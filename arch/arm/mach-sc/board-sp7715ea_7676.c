...
#if defined(CONFIG_TOUCHSCREEN_NT11004)
...
#if defined(CONFIG_TOUCHSCREEN_NT11004)
static struct novatek_platform_data nt11004_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vddsim2",
};
...
#if defined(CONFIG_TOUCHSCREEN_NT11004)
	{
		I2C_BOARD_INFO(NOVATEK_TS_NAME, NOVATEK_TS_ADDR),
		.platform_data = &nt11004_ts_info,
	},
#endif
};
